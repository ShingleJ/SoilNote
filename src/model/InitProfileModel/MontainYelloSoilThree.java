...
//			canvasBitmap.drawLine(0f, fmlLines[1], width, fmlLines[1], paint);
		...
		if (isDraw[2]) {
			//沉淀层——B
			DrawLegend.drawProfileB(canvasBitmap, paint, linePaint, width, fmlLines[2], fmlLines[3]);
//			canvasBitmap.drawLine(0f, fmlLines[2], width, fmlLines[2], paint);
		}
		if (isDraw[3]) {
			//过渡层——BC
			DrawLegend.drawProfileBC(canvasBitmap, paint, linePaint, width, fmlLines[3], fmlLines[4]);
//			canvasBitmap.drawLine(0f, fmlLines[3], width, fmlLines[3], paint);
		}
		if (isDraw[4]) {
			//母质质层——C
			DrawLegend.drawProfileC(canvasBitmap, paint, linePaint, width, fmlLines[4], height);
