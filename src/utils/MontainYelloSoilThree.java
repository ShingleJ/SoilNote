...
public class MontainYelloSoilThree extends ImageView{
	...
	private float two = (float)1038*15/60;
	private float three = (float)1038*20/60;
	private float four = (float)1038*50/60;
	...
	protected void onDraw(Canvas canvas) {
		...
		//过渡层——BC
		DrawLegend.DrawProfileBC(canvasBitmap, paint, width, fmlThree, fmlFour);
		...
		canvasBitmap.drawText("B", 650, (fmlThree+fmlTwo)/2, paint);
		canvasBitmap.drawText("BC", 650, (fmlThree+fmlFour)/2, paint);
